...
sequenceDiagram
    ...
    participant 権限処理
    participant 管理機能
    攻撃者->>Webアプリ: perm=255 を送信
    Webアプリ->>権限処理: 外部入力を権限値として評価
    権限処理->>権限処理: userPerm & ADMIN
    権限処理-->>Webアプリ: ADMINビット一致
    Webアプリ-->>攻撃者: 管理機能へアクセス許可
```
